module.exports = {
  "meta": {
    "title": "Venezuela Photography Expedition",
  ...
  "deltaWeather": {
    "title": "The Orinoco Delta weather — the honest read",
    "body": [
      "Climate sites call late June a near-washout; lodge reviews and first-hand trip reports say that's overstated for a photographer. By rainfall it IS the wettest fortnight of the year (≈59% wet-day odds around 22 June, and no drier shoulder to slip into). But July is also the region's clearest month — the signature of build-and-burst storms, not all-day grey.",
      "Every wet-season account follows the same rhythm: heavy rain in bursts (often the dawn transit hour or at sunset), sun in between, layered dramatic skies. Nobody reports being rained in for whole days. One August visitor: \"by noon the sun was shining again.\" The Orinoco Delta Lodge sits at 4.8/5; a July guest rated it 5/5 with no rain complaint.",
      "Strategy: shoot at first light and through the morning, treat afternoons as storm-and-edit time, and let the all-inclusive package re-order excursions around the weather. Pack for the real hardships — heat, humidity on gear (silica + a small fan), mud, and mosquitoes — not for lost days."
    ]
  },
  "route": [
    [
  ...
  "flights": {
    ...
    "rows": [
      ...
      },
      {
        ...
        "when": "Arrive 13:40 Tue 23 Jun · depart 16:11 Wed 8 Jul",
        "detail": "Booked: land 13:40 on 23 Jun; depart 16:11 on 8 Jul. An afternoon departure — be at Maiquetía ~3 hrs prior; no airport-hotel night needed. Hold a via-Panama (Copa) / Bogotá backup.",
        "bag": "Per AA fare",
  ...
  "weather": {
    ...
    "rows": [
      [
        "Los Roques",
        "~7–9 brief rain-days/mo · ~7.5 sun-hrs",
        "Driest, sunniest. Hurricane risk low now, rises Aug–Oct. The reliable finale.",
        "WORKABLE"
      ],
      [
        "Canaima / Angel Falls",
        "~15 rain-days/mo",
        "Wet & cloud-prone BUT full waterfall flow; falls can hide in cloud. Buffer day built in.",
        "MIXED — worth it"
      ],
      [
        "Orinoco Delta",
        "Wettest fortnight · ~59% wet-day odds",
        "Burst-and-clear, not all-day grey. Shoot dawn/mornings; package re-orders around storms. Heat, humidity, bugs are the real grind.",
        "WET · shoot AM"
      ]
    ]
  },
  "days": [
    {
      ...
      "blocks": [
        [
          "13:40",
          "Land Maiquetía (CCS). Immigration: eVisa printout + yellow-fever card ready."
        ],
        [
          "14:30",
          "Pre-arranged private transfer up to eastern Caracas (~45–60 min). Never use unregulated airport taxis."
        ],
        [
          "15:30",
    ...
    },
    {
      ...
      "blocks": [
        ...
        [
          "16:00",
          "Boat ride around the lodge — flora & fauna."
        ],
        [
          "17:30",
          "Sunset at Caño Manamo — possible freshwater (pink) dolphins."
        ],
        [
          "19:30",
    ...
    },
    {
      ...
      "blocks": [
        ...
        [
          "17:30",
          "Sunset at Caño Manamo — freshwater dolphins."
        ],
        [
          "19:30",
    ...
    },
    {
      ...
      "blocks": [
        ...
        [
          "17:30",
          "Sunset hike up El Faro (the lighthouse)."
        ],
        [
          "20:00",
    ...
    },
    {
      ...
      "region": "losroques",
      "base": "Gran Roque posada",
      "title": "Cayo de Agua — the signature sandbar",
      "sun": "Sunrise ~06:08 · Sunset ~18:57",
      "transit": "Full-day boat · ~45 min each way",
      "blocks": [
        [
          "06:00",
        ...
        [
          "08:30",
          "Boat to Cayo de Agua — the double-sided sandbar."
        ],
        [
          "09:30",
          "Shoot the sandbar before midday haze; polarizer."
        ],
        [
          "12:30",
          "Beach lunch; snorkel."
    ...
    },
    {
      ...
      "region": "losroques",
      "base": "Gran Roque posada",
      "title": "Island-hop: Madrisquí · Crasquí · Noronquí",
      "sun": "Sunrise ~06:08 · Sunset ~18:57",
    ...
    },
    {
      ...
      "region": "caracas",
      "base": "Departure",
      "title": "Depart Venezuela — 16:11 flight",
      "sun": "Sunrise ~06:10 · Sunset ~18:58",
      "transit": "City → CCS · ~45–60 min over the Ávila",
      "blocks": [
        [
          "Morning",
          "A last unhurried Caracas morning — coffee, El Hatillo or an Ávila viewpoint, gift shopping, repack."
        ],
        [
          "12:30",
          "Private transfer to Maiquetía (CCS) — ~45–60 min; aim to be at the terminal ~3 hrs before the 16:11 departure."
        ],
        [
          "16:11",
          "Depart Venezuela (your booked flight)."
        ],
        [
          "—",
          "End of expedition."
  ...
  "heroShots": [
    ...
    [
      "Cayo de Agua sandbar",
      "Day 13",
      "Turquoise-on-both-sides ribbon of sand — the Los Roques signature."
    ],
    [
      "Caracas / El Ávila",
      "Days 2, 11",
  ...
  "health": [
    [
      "eVisa",
      "A visa IS required and is NOT available on arrival — entering without one risks detention (US State Dept, primary). A digital eVisa for US citizens reportedly launched 6 Apr 2026 (~$180, MPPRE portal, 15–30 day processing) — verify on the official portal. With no Venezuelan consulate in the US, APPLY NOW and don't book non-refundable travel until it's issued."
    ],
    [
      "Yellow fever",
      "Active outbreak across 14+ states; CDC Level 2 (16 Mar 2026). Vaccinate ≥10 days before travel and carry the certificate. Recommended for this whole itinerary — Canaima and the Delta especially."
    ],
    [
      "Malaria",
      "Prophylaxis (atovaquone-proguanil, doxycycline or mefloquine) for BOTH the Orinoco Delta (Delta Amacuro) and Canaima (Bolívar). Caracas and Los Roques are no/low risk."
    ],
    [
      "Mosquitoes / dengue",
      "Heavy in the Delta. Strong DEET, long sleeves at dusk, a head net; treat clothing with permethrin."
    ],
    [
      "Insurance",
      "Carry medical-evacuation insurance — health infrastructure is weak and US consular help is \"extremely limited,\" especially outside Caracas."
    ]
  ],
  "safety": [
    [
      "Advisory level",
      "Venezuela is US State Dept Level 3 \"Reconsider Travel\" (19 Mar 2026), down from Level 4. The US Embassy in Caracas is only partially reopened; most consular services route through Bogotá."
    ],
    [
      "Canaima is in rural Bolívar",
  ...
  "money": [
    [
      "Bring USD cash",
      "ATMs don't take US cards. Bring enough clean, small-denomination USD for the whole trip. Los Roques and the lodges are cash-only."
    ],
    [
      "Park fees (cash)",
  ...
  "packing": [
    [
      "Bodies/lenses",
      "Canon R5 II + backup body; fast wide (lagoon, sandbars, Ávila), 24–70, and a 100–400/500 for Delta wildlife and the falls."
    ],
    [
      "Wet protection",
  ...
  "sources": [
    [
      "US State Dept — Venezuela Travel Advisory (Level 3, 19 Mar 2026)",
      "https://travel.state.gov/content/travel/en/traveladvisories/traveladvisories/venezuela-travel-advisory.html"
    ],
    [
      "CDC — Yellow Fever in Venezuela (Level 2, 16 Mar 2026)",
      "https://wwwnc.cdc.gov/travel/notices/level2/yellow-fever-venezuela"
    ],
    [
      "Conviasa — national itinerary (2026)",
      "https://apps.conviasa.aero/apps/itinerario/itinerario_pdf.php"
    ],
    [
      "Conviasa — booking calendar (operating days verified 15 Jun 2026)",
      "https://www.conviasa.aero/en"
    ],
    [
      "Waku Lodge — full-day Salto Ángel (Angel Falls) excursion, no overnight",
      "https://wakulodge.com/en/experiencias/full-day-salto-angel"
    ],
    [
      "Orinoco Delta Lodge — Plan 2 (3 days / 2 nights) day-by-day itinerary",
      "https://www.orinocodeltalodge.com/en/plan-2"
    ],
    [
      "Osprey Expeditions — Angel Falls FAQ (overflight ~$120, options)",
      "https://ospreyexpeditions.com/angel-falls-tour-most-frequently-asked-questions/"
    ],
    [
      "Orinoco Delta Lodge — how to get there (turnkey transfer)",
      "https://www.orinocodeltalodge.com/en/como-llegar"
    ],
    [
      "Orinoco Delta Lodge — TripAdvisor reviews (4.8/5)",
      "https://www.tripadvisor.com/Hotel_Review-g316098-d556489-Reviews-Orinoco_Delta_Lodge-Tucupita_Orinoco_Delta_Guayana_Region.html"
    ],
    [
      "El Nacional — Mukumbarí cable car re-suspended (22 May 2026)",
      "https://www.elnacional.com/2026/05/suspenden-temporalmente-el-servicio-del-sistema-de-telefericos-mukumbari-en-merida/"
    ],
    [
      "Climates to Travel — Venezuela (regional climate normals)",
      "https://www.climatestotravel.com/climate/venezuela"
    ]
  ],
  "placeholder": null,
  "deltaPricing": {
