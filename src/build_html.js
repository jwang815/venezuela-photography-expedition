...
var cp=d.canaimaPricing; var pricingHtml2='';
if(cp){pricingHtml2='<section><div class="wrap"><h2>'+esc(cp.title)+'<span class="lead">'+esc(cp.intro)+'</span></h2><table><thead><tr><th>Item</th><th class="nowrap">Per person</th><th class="nowrap">Total</th></tr></thead><tbody>'+cp.rows.map(function(r){return '<tr><td>'+esc(r[0])+'</td><td class="nowrap">'+esc(r[1])+'</td><td class="nowrap"><b>'+esc(r[2])+'</b></td></tr>';}).join('')+'<tr><td><b>Total</b></td><td></td><td class="nowrap"><b>'+esc(cp.total)+'</b></td></tr></tbody></table><div class="cut">'+esc(cp.note)+'</div></div></section>';}
...
${pricingHtml}${pricingHtml2}<section><div class="wrap"><h2>Route &amp; nights</h2><table><thead><tr><th>Base</th><th>Why</th><th>Nights</th></tr></thead><tbody>${routeRows}</tbody></table></div></section>
